...
{
    public class DispCrearVM
    {
        [Required(ErrorMessage = "Seleccione el objeto del gasto")]
        ...
        [Required(ErrorMessage = "Seleccione el proyecto")]
        [Display(Name = "Proceso proyecto")]
        public int? IdProyecto { get; set; }


        [Display(Name = "Descripción del objeto del gasto")]
        public string? DescripcionObjetoGasto { get; set; }


        [Required(ErrorMessage = "Seleccione el área usuaria")]
        [Display(Name = "Área usuaria")]
        public int? IdArea { get; set; }


        [Required(ErrorMessage = "Capture el importe")]
        [Range(0.01, 20000000, ErrorMessage = "El importe no puede exceder 20 millones")]
